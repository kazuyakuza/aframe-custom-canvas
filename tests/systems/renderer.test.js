...
suite("renderer", function () {
  ...
  test("default initialization", function (done) {
    ...
    var sortFunction;
    sceneEl.renderer.setOpaqueSort = function (s) {
      sortFunction = s;
    };
    sceneEl.addEventListener("loaded", function () {
      ...
      assert.strictEqual(
        renderingEngine.outputColorSpace,
  ...
  test("change renderer colorManagement", function (done) {
    ...
    sceneEl.addEventListener("loaded", function () {
      ...
      assert.equal(
        sceneEl.renderer.outputColorSpace,
  ...
  test("change renderer sortTransparentObjects", function (done) {
    ...
    var sortFunction;
    sceneEl.renderer.setTransparentSort = function (s) {
      sortFunction = s;
    };
